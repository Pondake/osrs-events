...
- A weekly check proposes wiki images for bosses without an icon, and offers
  to hand a boss back to the icon package once it ships a pet for it. It
  never applies one — proposals queue for approval, dismissals are
  remembered.
