<template>
    <div class="space-y-5 py-2">
        ...
        <!-- The Discord webhook used to sit here. It moved to its own
             Announcements tab on 2026-09-12: this tab answers who may open
             the event, which is a different question from who hears about
             it, and a host looking for the webhook had no reason to come
             here. -->
