...
export const AUDIT_STYLES = {
    ...
    'supporter.created': { color: 'success', icon: 'i-lucide-heart-handshake' },
    'supporter.updated': { color: 'neutral', icon: 'i-lucide-pencil' },
    'supporter.deleted': { color: 'error', icon: 'i-lucide-trash-2' },
